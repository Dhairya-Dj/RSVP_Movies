...
/* Following Columns in the movie table have Null values :
	- country = 20
...
-- High number of movies are also produced in the month of September & October
...
-- Drama genre had the highest number of movies produced overall with 4285 Movies.
...
/* Action & Horror movies have highest & lowest average duration as 112.88 & 92.72 respectively.
- Romance & Crime Movies are 2nd & 3rd in average duration respectively.*/
...
FROM genre
GROUP BY genre) AS genre_summary
WHERE genre = "THRILLER";

-- Thriller has genre_rank = 3 and movie_count = 1484
...
-- Kirket & Love in Kilnerry top rated movies with average ratings of 10.
...
-- 24 Drama movies released during March 2017 in the USA had more than 1,000 votes
...
-- These 8 movies belong to top 3 genres ( Drama, Crime, Action )
...
-- 361 movies had median rating of 8 with above constrains.
...
-- German movies get significantly high number of votes over Italian movies.
-- Answer is Yes
...
-- James Mangold, Anthony Russo, Soubin Shahir are Top 3 Directors with above constriants.
...
-- Action movies have highest average & moving average duration.
-- Whereas Thrillers have highest running total duration.
...
-- Star Cinema & Twentieth Century Fox are the top two production houses that have produced the highest number of hits (median rating >= 8) among multilingual movies.
...
-- Parvathy Thiruvothu, Susan Brown & Amanda Lawrence are the top 3 actresses based on number of Super Hit movies (average rating >8) in drama genre.
